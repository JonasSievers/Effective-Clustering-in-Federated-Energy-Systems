...
def run_federated_benchmark_model(
    ...
    for federated_round  in range(federated_rounds):
        ...
        for cluster_number, users_in_cluster in cluster_users.items():
            ...
            global_model = tf.keras.models.load_model(f'{save_path}/wandb/{wb_project}_{wb_model_name}_c{cluster_number}_FLround{federated_round}.keras', custom_objects=custom_objects, compile=False, safe_mode=False)
